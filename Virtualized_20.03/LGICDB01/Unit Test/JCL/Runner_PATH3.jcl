...
//         DD DISP=SHR,DSN=SALESSUP.RXN3.DEV3.CICSLOAD
//SLSF001  DD DISP=SHR,DSN=SALESSUP.RXN3.DEV3.CICSLOAD.SSD
//*
//*STEPLIB  DD DISP=SHR,DSN=CX.R170000.SMPE.SLCXLOAD
//*         DD DISP=SHR,DSN=CEE.SCEERUN
//*         DD DISP=SHR,DSN=EFHLAW0.CICSDB2.COBOL61.LOAD
//*
//*SLSF001  DD DISP=SHR,DSN=EFHLAW0.CICSDB2.LISTCSS
//*
//CEEOPTS  DD  *
STORAGE(00,00,00)
/*
